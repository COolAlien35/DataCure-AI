...
"[project]/Downloads/data-cure-ai-dashboard/hooks/useJobProgress.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useJobProgress(job) {
    _s();
    const [animatedProgress, setAnimatedProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(job.progress);
        ...
        "useJobProgress.useEffect": ()=>{
            ...
            if (job.status === "processing") {
                ...
                const interval = setInterval({
                    "useJobProgress.useEffect.interval": ()=>{
                        setAnimatedProgress({
                            "useJobProgress.useEffect.interval": (prev)=>{
                                if (prev >= 100) return 100;
                                return Math.min(prev + 0.5, job.progress + 5);
                            }
                        }["useJobProgress.useEffect.interval"]);
                    }
                }["useJobProgress.useEffect.interval"], 500);
                return ({
                    "useJobProgress.useEffect": ()=>clearInterval(interval)
                })["useJobProgress.useEffect"];
            } else {
...
_s(useJobProgress, "MY06Z2UJdwOKN4zaKaQab5DwCOc=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$hooks$2f$useJobProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/data-cure-ai-dashboard/hooks/useJobProgress.ts [app-client] (ecmascript)");
...
function JobDetailsPage({ params }) {
    ...
    const job = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockJobs"].find((j)=>j.id === id) || __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockJobs"][0];
    const animatedProgress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$hooks$2f$useJobProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useJobProgress"])(job);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JobDetailsPage.useEffect": ()=>{
            const timer = setTimeout({
                "JobDetailsPage.useEffect.timer": ()=>setIsLoading(false)
            }["JobDetailsPage.useEffect.timer"], 800);
            return ({
                "JobDetailsPage.useEffect": ()=>clearTimeout(timer)
            })["JobDetailsPage.useEffect"];
        }
    }["JobDetailsPage.useEffect"], []);
    ...
    const filteredRecords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "JobDetailsPage.useMemo[filteredRecords]": ()=>{
            let records = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProviderRecords"].filter({
    ...
    const exportableRecords = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProviderRecords"].filter((r)=>r.overallConfidence >= confidenceThreshold[0]);
...
_s(JobDetailsPage, "NOatPa+uQ6sq1MYbw3JKOC+aV6E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$data$2d$cure$2d$ai$2d$dashboard$2f$hooks$2f$useJobProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useJobProgress"]
    ];
});
_c = JobDetailsPage;
var _c;
...
//# sourceMappingURL=Downloads_data-cure-ai-dashboard_a483d826._.js.map